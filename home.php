          ...
          <div class="col-md-5">
            <div class="card card-primary">
              ...
              <form action="" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input name="nome" type="text" class="form-control" id="exampleInputPassword1" placeholder="Insira o nome de Produto...">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Especificações</label>
                    <input name="espe" type="text" class="form-control" id="exampleInputPassword1" placeholder="Insira a especificações...">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="exampleInputPassword1">Preço bruto</label>
                    <input name="preco" type="text" class="form-control" id="exampleInputPassword1" placeholder="R$ 00,00" style="text-align: center;">
                  </div>
              ...
              <?php
                  ...
                  $insert = "INSERT INTO Tbprojeto(Nomeproduto,Espeproduto,PIproduto,Dataproduto) VALUES(:nome,:espe,:preco,:dataPedido)";
